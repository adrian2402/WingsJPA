...
public class LibroExporterPDF {
    ...
    public LibroExporterPDF(List<Producto> listaProductos) {
        super();
    ...
    private void escribirCabeceraDeLaTabla(PdfPTable tabla) {
        ...
        celda.setPhrase(new Phrase("Precio Costo", fuente));
        tabla.addCell(celda);

        celda.setPhrase(new Phrase("Precio Venta", fuente));
        tabla.addCell(celda);
    ...
    private void escribirDatosDeLaTabla(PdfPTable tabla) {
        for (Producto producto : listaProductos) {
            ...
            tabla.addCell(producto.getProveedor().getNombre());
        }
    }
